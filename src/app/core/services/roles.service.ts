...
import { HttpClient } from '@angular/common/http';
import { Observable } from 'rxjs';
import { Role, RoleRequest, PagePermissionRequest } from '../models/role.model';
...
export class RoleService {
  ...
  assignPagePermissions(id: number, request: PagePermissionRequest[]): Observable<Role> {
    return this.http.put<Role>(`${this.baseUrl}/${id}/page-permissions`, request);
  }
}